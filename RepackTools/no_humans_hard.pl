...
@cutscenes=qw/cs9mm csbat csbball csbdup csbeerbottle csbettina csbfyst csbigbear csbigbear2 csbigbearthin csbjd csblue2 csblue2_2 csblue2_3 csblue2_4 csblue2_5 csblue3 csblue4 csbmybu csbmydj csbogman csbong csbottle csbpack csbullhorn csburger1 csburger2 cscarryall cscase cscatalina cscesar cscigrydr3 csclaude csclip cscloth cscoketube cscolt45 csconboss cscopmobile2 cscrackbottle cscrackpipe cscrowbar csdancea csdanceb csdeserteagle csdomino csdope csdossier csdrug1 csdwayne csemmet csfarlie csflower csframe csgfprox csgiantwrench csgirliecase csgolfclub csgrove1 csheadsack csheckler1 csheckler2 cshelper1 cshelper2 cshernandez csho csjanitor csjar csjethro csjizzy csjose cskendl cskentpaul csknife cslilbil csmaccer csmadddogg csmafgoon1_maffa csmafgoon2_maffb csmaria csmech csmomchair csogloc csoglocburger csoilcan csom2 csomost cspapers cspen cspencil csplas1 cspro1 cspulaski cspunter1 cspunter2 csrosenberg csryder cssalvatore cssilenced cssilverman cssindacco csslut cssmg cssmoke cssmokevest cssmokevest2 csspade csspray csstew cssuit2 cssuitcase cssuzie cssweet cstbone cstenpenny cstexan cstexan2 cstony_x cstoolkit cstorino cstriada cstriada2 cstriada3 cstriboss cstruth cswallphone cswheel cswmori cswoozie cswrench cszero fam4 fam5 gfriend/;
...
print "$want_model -> $model\n";
`cp ./gta3-src/$want_model.txd cutscene-dst/$model.txd`;
`cp ./gta3-src/$want_model.dff cutscene-dst/$model.dff`;
}


`perl /dev/shm/packer.pl Dst/Models/gta3.img gta3-src gta3-dst/`;
`perl /dev/shm/packer.pl Dst/Models/cutscene.img cutscene-src cutscene-dst/`;
