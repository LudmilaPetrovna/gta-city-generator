...
Пытаемся найти любые реальные данные о городе (в нашем случае Йошкар-Ола), которые хоть как-то помогут в создании игровой карты. Или вообще хоть как-то связанные с городом.

* Спутниковые снимки или иные картографические подложки.
* Панорамные снимки улиц или простые фотографии как источник данных с высокой точностью.
* Каталоги организаций как источник куда мапить социальные службы (скорая, пожарка, полиция), так и коммерческие, вроде казино и клубов.
* Неофициальные названия (что-то уровня wikimapia), что возможно позволит замапить народные названия и прозвища, возможно нарисовать граффити на стенах.
* Любые другие карты, от карты освещения до чистоты воздуха - это поможет расставить фонари и системы частиц, выбрасывающие дым.
...
* Идем в Операции -> Операции с выделенной областью -> По координатам ![Скриншот](./imgs/import-sasplanet-1-dialog.png)
* Вводим координаты нужной области ![Скриншот](./imgs/import-sasplanet-2-coords.png)
* Выбираем вкладку `Экспорт` и выставляем опции как на скриншоте: ![Скриншот](./imgs/import-sasplanet-3-levels.png)
